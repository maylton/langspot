...
export const ASSESSMENT_SECTION_SKILLS = ['grammar', 'vocabulary', 'reading', 'listening', 'writing', 'speaking', 'use_of_english'] as const satisfies readonly AssessmentSectionSkill[];
